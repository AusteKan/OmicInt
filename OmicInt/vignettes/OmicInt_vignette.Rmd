...
<br>
<br>
![**Density plot examples. ](Figure2.jpg){width=80%}
<br>
<br>
...
<br>
<br>
![**Feature distribution plot examples. ](Figure3.jpg){width=80%}
<br>
<br>
<br>
<br>
...
![**Interactive 3D feature distribution. ](Figure4.jpg){width=80%}
<br>
<br>
<br>
<br>
...
<br>
<br>
![**Summary function examples. ](Figure5.jpg){width=80%}
<br>
<br>
<br>
<br>
...
<br>
<br>
![**Figure 3**. Dendogram with mapped cellular locations where coloured gene symbols represent the identified clusters and coloured branches show smaller subclusters. ](location_map.jpeg){width=80%}
<br>
<br>
Similarly, the function *class_map* provides visualisation of how the highest and lowest $LFC_{score}$  genes cluster based on protein class. In addition to a data frame generated by *score_genes*, the function also requires a *num* parameter to specify the number of genes to consider from top upregulated and downregulated genes, if this option is not selected all genes will be used (Fig.4).
<br>
<br>
<br>
<br>
...
<br>
<br>
![**Figure 4**.Dendogram with mapped protein functions where coloured gene symbols represent the identified clusters and coloured branches show smaller subclusters. ](class_map.jpeg){width=80%}
<br>
<br>
<br>
<br>
...
<br>
<br>
![**Figure 5**. House keeping gene distribution example. The red marker indicates the mean for the group and violin plots allow to assess global distribution patterns. ](HK_genes.jpg){width=80%}
<br>
<br> 
...
![**Summary function examples. ](Figure6.jpg){width=80%}
<br>
<br>
...
<br>
<br>
The outputs allow to assess how genes distribute in a subset for different conditions (Fig.6) and how the individual gene values vary in the selected subgroup  (Fig.7). 
<br>
<br>
![**Figure 6**. Gene distribution patterns for a specific expression pattern subset where mean values (signified with a red point) are connected to highlight the pattern features with respect to the mean value (example is from a "down-up-down" pattern group). ](pattern_plots_1.jpg){width=80%}
<br>
<br>
![**Figure 7**. Individual gene distributions when selecting a specific expression pattern and range (example is from a "down-up-down" pattern group). ](pattern_plots_2.jpg){width=80%}
...
<br>
<br>
![**Cluster heatmap examples. ](Figure7.jpg){width=50%}
<br>
<br>
<br>
<br>
...
<br>
<br>
![**Cluster heatmap examples. ](Figure8.jpg){width=80%}
<br>
<br>
...
<br>
<br>
![**CpG summary examples. ](Figure9.jpg){width=80%}
![**CpG symmary examples. ](Figure10.jpg){width=80%}
<br>
<br>
```{r}
...
<br>
<br>
Function *miRNA_summary_validated* allows to check how many of the differentially changed genes have known miRNAs. The information on validated/known miRNAs is collected from multiple databases mining, namely [miRecords](http://c1.accurascience.com/miRecords/), [TarBase](https://carolina.imis.athena-innovation.gr/diana_tools/web/index.php?r=tarbasev8%2Findex), [miRTarBase](https://mirtarbase.cuhk.edu.cn/~miRTarBase/miRTarBase_2022/php/index.php),[PhenomiR](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2847718/), [miR2Disease](http://www.mir2disease.org/), [Pharmaco-miR](http://www.pharmaco-mir.org/). The function also returns a data table with miRNA information that could be used in designing RNA interference experiments.
<br>
<br>
```{r}
...
<br>
<br>
![**miRNA network plot example. ](Figure13.jpg){width=80%}
<br>
<br>
