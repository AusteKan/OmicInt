#' @title class_map
#'
#' @description Function provides visualisation of how the highest and lowest LFCscore  genes cluster based on protein class data.
#'
...
class_map<-function(data, num=0){
  ...
  dendextend::colored_bars(colors =as.vector(col_vector_names), dend = dend, rowLabels = "Class",add = TRUE)
  graphics::legend("topright", legend = names(colors), fill = as.vector(colors),xpd=TRUE,  cex=0.7, bty='n', title="Protein class")
}
