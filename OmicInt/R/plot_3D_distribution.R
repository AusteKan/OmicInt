...
#'
#' @description Function allows to explore 3D distribution between the number of interactors, LFCscore and p.adj values.
#'
#' @param data data frame containing processed expression file from score_genes with LFCscore
#' @param type default value is "association", the user can select how to color data points depending on association or specificity score (e.g., selecting "specificity")
