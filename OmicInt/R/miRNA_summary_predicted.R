...
#' #head(return_df)
#' @export
miRNA_summary_predicted<-function(data, type="class"){

  #plot structures
  #access data

  #miRNA data preparation
  miRNA_url <- RCurl::getURL("https://gitlab.com/Algorithm379/databases/-/raw/main/miRNA_df_predicted.csv")
